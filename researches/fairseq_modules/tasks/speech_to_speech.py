...
from fairseq_modules.data.audio.data_cfg import MultitaskConfig, S2SDataConfig
from fairseq_modules.data.audio.speech_to_speech_dataset import SpeechToSpeechDatasetCreator
from fairseq_modules.data.audio.speech_to_text_dataset import (
    SpeechToTextDataset,
    TextTargetMultitaskData,
)
from fairseq.tasks import LegacyFairseqTask, register_task
from fairseq_modules.tasks.speech_to_text import DummyMultiTask
from fairseq_modules.tasks.text_to_speech import batch_mel_cepstral_distortion
