...
from fairseq_modules.data.audio import rand_uniform
from fairseq_modules.data.audio.dataset_transforms import (
    AudioDatasetTransform,
    register_audio_dataset_transform,
)
from fairseq_modules.data.audio.waveform_transforms.noiseaugment import (
